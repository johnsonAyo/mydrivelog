...
export default async function LearnersPage() {
  ...
  return <ProductShell brand="MyDriveLog" title="Learners" description="Keep the people you teach in one place." identity="Independent instructor workspace" actions={<InstructorSignOut />} navigation={[
