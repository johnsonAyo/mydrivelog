...
export const metadata: Metadata = { title: "Scheduling settings — DriveTrack" };
...
export default async function SchedulingPage() {
  ...
  return <ProductShell brand="DriveTrack" title="Scheduling settings" description="Set the rules for new availability and online lesson bookings." identity="Independent instructor workspace" navigation={[
