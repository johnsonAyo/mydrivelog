...
export default async function SchedulingPage() {
  ...
  return <ProductShell brand="MyDriveLog" title="Scheduling settings" description="Set the rules for new availability and online lesson bookings." identity="Independent instructor workspace" actions={<InstructorSignOut />} navigation={[
    { href: "/calendar", label: "Calendar", icon: <CalendarDays size={17} /> },
    { href: "/learners", label: "Learners", icon: <UsersRound size={17} /> },
