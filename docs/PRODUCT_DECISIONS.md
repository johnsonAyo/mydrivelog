...
20. An instructor plans availability as named, editable lists of exact dates and lesson times, mirroring the messages they currently write by hand. They may keep multiple private drafts and return to them later. A range-to-times generator is an optional shortcut, not the required path.
