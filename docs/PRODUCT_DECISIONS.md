...
13. After the pilot, each new Solo workspace will start a full-featured 14-day trial. No card is required at signup; the trial end date will be visible in the product. Pilot workspaces do not have a trial deadline.
14. After the pilot, instructors can subscribe through self-serve checkout at the end of the trial. Until subscription billing is implemented and verified, no checkout or paid-state claim should be presented as live.
15. After the pilot, an unpaid workspace will become read-only at trial expiry: existing records remain viewable and exportable, but new bookings and edits are unavailable. Expired unpaid records remain accessible indefinitely, unless the instructor requests deletion. A later subscription restores write access.
...
24. During the pilot season, customer-facing signup and marketing copy says "pilot", not "free trial", and does not advertise a 14-day period or Solo pricing. Pilot workspaces remain active indefinitely until explicitly ended by the operator. The priced 14-day free-trial offer is reserved for after the pilot.
